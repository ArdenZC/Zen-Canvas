...
pub use db::{
    ...
    get_stats_summary, init_db, insert_file, search_files, upsert_files_by_paths, FileRecordDto,
    FileSearchResult, InsertFileRequest, PagedFilesResult, Rule, RuleExecutionSummary,
    StatsSummary,
};
pub use file_ops::{

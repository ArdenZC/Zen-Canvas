...
| R-PLAT-001 | P2 | macOS provider/external/network-volume and broader race behavior is less verified than core native mutation path | V2.1 keeps provider identity/materialization, source-retirement and capability layers fail-closed; bind expanded race/performance and any real-volume claims to exact-head Apple Silicon fixtures | active |

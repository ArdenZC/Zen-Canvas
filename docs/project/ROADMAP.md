...
- **W2-05 — Interaction Convergence + Virtualized List:** **ACTIVE IMPLEMENTATION** on `feat/w2-05-interaction-convergence-virtualized-list`; Draft PR #106 is open and exact-head hosted CI is pending. This is the first Track allowed to converge shared selection/focus interaction.

...
Authority: [`W6-02-FIRST-VALUE-RECOVERY-MATURITY-ACTIVATION.md`](W6-02-FIRST-VALUE-RECOVERY-MATURITY-AUDIT-ACTIVATION.md)

> Note: the activation link above is corrected below because the authoritative activation filename is `W6-02-FIRST-VALUE-RECOVERY-MATURITY-ACTIVATION.md`.

Authoritative activation: [`W6-02-FIRST-VALUE-RECOVERY-MATURITY-ACTIVATION.md`](W6-02-FIRST-VALUE-RECOVERY-MATURITY-ACTIVATION.md)

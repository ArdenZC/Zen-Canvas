  ...
  it("uses an application dialog before a Review candidate enters Safe Trash", async () => {
    await act(async () => root.render(createElement(StorageCleanupView as unknown as (props: Record<string, unknown>) => React.ReactElement, {
      api: {
        ...
        getAnalysisFinding: async () => ({
          id: "review-cache",
          findingKey: "review-cache-key",
          runId: "job-1",
          ...
          primarySubjectId: reviewAnalysis.candidates[0].path,
          pathSnapshot: reviewAnalysis.candidates[0].path,
          identitySnapshot: { path: reviewAnalysis.candidates[0].path },
        ...
        setAnalysisFindingDecision: async () => ({
          findingKey: "review-cache-key",
